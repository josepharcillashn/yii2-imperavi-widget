...
use josepharcillashn\imperavi\tests\functional\data\overrides\TestAsset;
...
final class AssetTest extends TestCase
{
    ...
    public function testRegister()
    {
        ...
        $content = $view->renderFile('@josepharcillashn/imperavi/tests/data/views/rawlayout.php');
